...
#ifndef __PICO_FLASH_MODULE_H
#define __PICO_FLASH_MODULE_H
...
#warning ===============> Firmware Pico-Flash-Module built as RELEASE VERSION.
#else  // RELEASE_VERSION
#warning ===============> Firmware Pico-Flash-Module built as DEVELOPER VERSION.
...
static UINT8 flash_erase(UINT32 DataOffset);
